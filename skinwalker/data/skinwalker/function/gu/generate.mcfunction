...
execute unless score @s gu.uuid.0 matches -2147483648.. run function skinwalker:gu/zzz/store_uuid
...
function skinwalker:gu/zzz/get_hexes with storage gu:temp
function skinwalker:gu/zzz/concat_uuid with storage gu:temp